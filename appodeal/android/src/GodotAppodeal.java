...
public class GodotAppodeal extends Godot.SingletonBase {
    ...
    public GodotAppodeal(Activity p_activity) {
        ...
        registerClass("Appodeal", new String[]{
                ...
                "isRewardedVideoLoaded", "isNonSkipVideoLoaded", "showRewardedVideoAd", "showNonSkipVideoAd", "loadNonSkipVideoAd", "loadBannerAd",
    ...
    public void showBannerAd(String type, String placement) {

        if (type.equals("top")) {
            Appodeal.show(activity, Appodeal.BANNER_TOP, placement);
    ...
    public void showVideoAd(String placement) {
        Appodeal.show(activity, Appodeal.SKIPPABLE_VIDEO, placement);
        Log.d("godot", "show video");
    }

    public void showNonSkipVideoAd(String placement) {
        Appodeal.show(activity, Appodeal.NON_SKIPPABLE_VIDEO, placement);
        Log.d("godot", "show video");
    }
    ...
    public void showInterstitialAndVideoAds(String placement) {
        Appodeal.show(activity, Appodeal.SKIPPABLE_VIDEO | Appodeal.INTERSTITIAL, placement);
    ...
    public boolean isNonSkipVideoLoaded() {
        boolean loaded;
        loaded = Appodeal.isLoaded(Appodeal.NON_SKIPPABLE_VIDEO);
        return loaded;
    }
